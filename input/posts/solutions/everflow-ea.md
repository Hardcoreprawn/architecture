...
Capabilities are the things an organisation needs to execute its strategy. Understanding what capabilities are present and their maturity is vital to ensure the business can 'grow up' into its strategy and continue to be profitable.

![Capability Domains, Everflow 2023](../../media/everflow-capability-domains.png)

Capabilities can be broadly categorised into two groups:

* Core - critical to the function and identity of the organisation
* Context - secondary functions necessary to the operation

One way to consider this is whether your customers care about the capability. Is that capability why they talk to you or use your products or services?

If they do care, then it's a core capability. It's essential and critical to your business.

If they're not bothered, then it is context. You have to do it; it can be a defining and strategic advantage, but it's not why your customers chose you.

Focus your efforts on Core capabilities as they will provide more significant returns and opportunities.

Handle contextual capabilities efficiently and well enough. Your return on investment will be much smaller, as it won't improve sales or performance To the same degree.

In addition, capabilities are usually grouped in specialized or general groups. Around 80% of capabilities are common to most businesses, with the other 20% specific to the industry.

Understanding this differentiation helps show how the business is similar to and different from other companies.

As differentiation is a crucial way to stand out and grow in a busy or commodity market, understanding how you are different and which core, specialized areas to focus on will help create more of an impact on how your business develops.

For a product development team, understanding the specialized areas of the business helps them target unique and critical functionality and ignore work that won't help improve the business.
