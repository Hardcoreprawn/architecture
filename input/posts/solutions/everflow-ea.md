...
Capabilities are the things an organisation needs to reach its goals. Understanding what capabilities are present and their maturity is vital to ensure the business can 'grow up' into its strategy and continue to be profitable.

![Capability Domains, Everflow 2023](../../media/everflow-capability-domains.png)

Capabilities divide into two groups:
